-- ============================================
-- FriendLens MVP - Complete Database Setup
...
CREATE TABLE IF NOT EXISTS public.results (
  ...
  microtype_id TEXT NOT NULL, -- Stores primary archetype ID (6-dimension system)
  archetype_id TEXT NOT NULL, -- Stores 16-type ID (e.g., "FL01")
  microtype_tags TEXT[], -- Array of archetype IDs [primary, secondary]
...
-- 2. Run this SQL to make them admin (replace YOUR_USER_UUID):
--    INSERT INTO public.user_roles (user_id, role_id)
--    SELECT 'YOUR_USER_UUID', id FROM public.roles WHERE name = 'admin';
-- ============================================
