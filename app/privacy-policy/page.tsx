...
export const metadata = {
  title: "Privacy Policy | FriendLens",
  description: "Privacy Policy for FriendLens.ai",
}
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        <div className="prose prose-gray max-w-none space-y-6 text-gray-700 leading-relaxed">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-10">Interpretation and Definitions</h2>

          <h3 className="text-xl font-semibold text-gray-900 mt-8">Interpretation</h3>
          <p>
          ...
          <ul className="list-disc pl-6 space-y-3">
            ...
            <li>
              ...
              &quot;Our&quot; in this Agreement) refers to FriendLens.ai.
            </li>
            <li>
            ...
            <li>
              <strong>Device</strong> means any device that can access the Service such as a computer, a mobile phone or
              a digital tablet.
            </li>
            <li>
            ...
            <li>
              <strong>Website</strong> refers to FriendLens.ai, accessible from{" "}
              <a href="https://friendlens.ai" className="text-indigo-600 hover:text-indigo-800 underline">
                https://friendlens.ai
              </a>
            </li>
            <li>
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-10">Collecting and Using Your Personal Data</h2>

          <h3 className="text-xl font-semibold text-gray-900 mt-8">Types of Data Collected</h3>
          ...
          <h4 className="text-lg font-semibold text-gray-900 mt-6">Usage Data</h4>
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-8">Tracking Technologies and Cookies</h3>
          <p>
          ...
          <div className="bg-gray-50 rounded-lg p-6 space-y-4 my-6">
            <div>
              <p className="font-semibold text-gray-900">Necessary / Essential Cookies</p>
              <p className="text-sm text-gray-600">Type: Session Cookies &middot; Administered by: Us</p>
              <p className="mt-1">
                These Cookies are essential to provide You with services available through the Website and to enable You
            ...
            <div className="border-t border-gray-200 pt-4">
              ...
              <p className="text-sm text-gray-600">Type: Persistent Cookies &middot; Administered by: Us</p>
              <p className="mt-1">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-8">Use of Your Personal Data</h3>
          ...
          <ul className="list-disc pl-6 space-y-3">
            <li>
              <strong>With Service Providers:</strong> We will not share Your personal information with Service Providers
              to monitor and analyze the use of our Service, to contact You.
            </li>
            <li>
              <strong>For business transfers:</strong> We will not share or transfer Your personal information in
              connection with, or during negotiations of, any merger, sale of Company assets, financing, or acquisition
              of all or a portion of Our business to another company.
            </li>
            <li>
              <strong>With business partners:</strong> We will not share Your information with Our business partners to
              offer You certain products, services or promotions.
            </li>
            <li>
              <strong>With other users:</strong> when You share personal information or otherwise interact in the public
              areas with other users, such information will not be viewed by all users and will not be publicly
              distributed outside.
            </li>
            <li>
              <strong>With Your consent:</strong> We will not disclose Your personal information for any other purpose
              with Your consent.
            </li>
          </ul>

          <h3 className="text-xl font-semibold text-gray-900 mt-8">Retention of Your Personal Data</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-8">Transfer of Your Personal Data</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-8">Delete Your Personal Data</h3>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-10">Disclosure of Your Personal Data</h2>

          <h3 className="text-xl font-semibold text-gray-900 mt-8">Business Transactions</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-8">Law enforcement</h3>
          <p>
            Under certain circumstances, the Company will not be required to disclose Your Personal Data if required to
            do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
          </p>

          <h3 className="text-xl font-semibold text-gray-900 mt-8">Other legal requirements</h3>
          <p>
            The Company will not disclose Your Personal Data in the good faith belief that such action is necessary to:
          </p>
          <ul className="list-disc pl-6 space-y-2">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-10">Security of Your Personal Data</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-10">Children&apos;s Privacy</h2>
          <p>
            ...
            Personal Data from anyone under the age of 13 without verification of parental consent, We will take steps
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-10">Links to Other Websites</h2>
          <p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              ...
              <a href="https://friendlens.ai/contact" className="text-indigo-600 hover:text-indigo-800 underline">
                https://friendlens.ai/contact
              </a>
            </li>
          </ul>
        </div>
